...
namespace test
{
    namespace dynstack
    {
        ...
        {
            ::dynstack::storage::LIFO_std_Stack<float> tmp(12);
        ...
        TEST(LIFO_std, pushBack_reference)
        {
            ::dynstack::storage::LIFO_std_Stack<float> tmp(12);
        ...
        TEST(LIFO_std, pushBack_move)
        {
            /*::dynstack::storage::LIFO_std_Stack< std::unique_ptr<float> > tmp(12);
        ...
        TEST(LIFO_std, pushBack_uniquePtr)
        {
            ::dynstack::storage::LIFO_std_Stack< float > tmp(12);
        ...
        TEST(LIFO_std, back)
        {
            ...
            ::dynstack::storage::LIFO_std_Stack< float > tmp2(12);
        ...
        TEST(LIFO_std, pusbBack_UpperLimit)
        {
            ::dynstack::storage::LIFO_std_Stack< float > tmp(12);
