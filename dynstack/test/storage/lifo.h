...
namespace test
{
    namespace dynstack
    {
        TEST(LIFO, Ctr)
        {
            ...
            ::dynstack::storage::LIFO_Stack<float> tmp2( tmp1 );
            ...
            ::dynstack::storage::LIFO_Stack< float > tmp3( std::move(tmp1) );
        ...
        TEST(LIFO, capacity)
        {
            ::dynstack::storage::LIFO_Stack<float> tmp(12);
        ...
        TEST(LIFO, pushBack_reference)
        {
            ...
            ASSERT_EQ(tmp.size(), 3.0f);
            ASSERT_EQ(tmp.pop_back(), 3.0f);
            ASSERT_EQ(tmp.pop_back(), 2.0f);
            ASSERT_EQ(tmp.pop_back(), 1.0f);
        }

        TEST(LIFO, pushBack_move)
        {
            /*::dynstack::storage::LIFO_Stack< std::unique_ptr<float> > tmp(12);
        ...
        TEST(LIFO, back)
        {
            ...
            ::dynstack::storage::LIFO_Stack< float > tmp2(12);
